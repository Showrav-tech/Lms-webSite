 ...
 {lectureCompleted: 4,totalLectures: 4},
  ...
  return (
    ...
    <div className='md:px-36 px-8 pt-10'>
      <h1 className='text-2xl font-semibold'>My Enrollmnets</h1>
      ...
      <th className='px-4 py-3 font-semibold truncate'>Completed</th>
        ...
        <tbody className='text-gray-700'>
          ...
          <tr key={index} className='border-b border-gray-500/20'>
            ...
            <td className='px-4 py-3 mx-sm:hidden'>
      {
...
<td className='px-4 py-3 mx-sm:hidden'> 
  ...
  <td className='px-4 py-3 mx-sm:text-right'>
    <button className='px-3 sm:px-3 py-1.5 sm:py-2 bg-blue-600 max-sm:text-xs text-white'
