...
import { AppContext } from '../../context/appContext'; // Ensured lowercase 'a' to match index.jsx
...
const CourseDetails = () => {
  ...
  // Safely grab the context. If the context itself is undefined, fallback to an empty object 
  // so the destructuring doesn't crash the entire app layout.
  ...
  // If context failed to load or data isn't ready, safely show loading
  if (!context.allCourses || !courseData) {
    return <Loading />;
  }
